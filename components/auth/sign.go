...
import (
	...
	"github.com/qiniu/stack-go/components/bytes/seekable"
)

const qiniuHeaderPrefix = "X-Qiniu-"

// SignRequest sign normal request
func SignRequest(sk []byte, req *http.Request) ([]byte, error) {
	...
	if isNeedToSignBody(req, ctType) {
...
func isNeedToSignBody(req *http.Request, ctType string) bool {
